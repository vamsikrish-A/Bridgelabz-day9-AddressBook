        ...
        while (choice != 5) {
            ...
            if (choice == 1) {
                ...
                if (contactList.numContacts() < 10) {
                    ...
                    System.out.println("sorry, you cannot add more contacts.");
                ...
                System.out.println("you have "+contactList.numContacts() +"contacts in your book.");
